...
{{< figure src="img/old-varsity.jpg" alt="1973 Schwinn Varsity" caption="The bike how I got it." captionPosition="center" >}}
...
{{< figure src="img/old-tires.jpg" alt="Old bike tires" caption="I'm pretty sure this was the original tire that came with the bike from the factory." captionPosition="center" >}}
...
{{< figure src="img/bell-tube.jpg" alt="27in Bell standard bike tubes" caption="Yup. That's a bike tube..." captionPosition="center" >}}
...
{{< figure src="img/continental-tire.png" alt="Continental Ride Tour Tire" caption="Continental Ride Tour tire" captionPosition="center" >}}
...
{{< figure src="img/big-tire-box.jpg" alt="Large tire box" caption="This is the box they arrived in." captionPosition="center" >}}
...
{{< figure src="img/rim-tape-example.jpg" alt="Rim tape example" caption="Rim tape example (from [parktool.com](https://www.parktool.com/))" captionPosition="center" >}}
...
{{< figure src="img/handlebar-endcaps.png" alt="New handlebar endcaps" caption="New handlebar endcaps" captionPosition="center" >}}

### Brake Pads

The brakes were old, so I got some new ones at Walmart.

{{< figure src="img/bell-brake-pads.png" alt="Bell brake pads" caption="Just some Bell brand brake pads" captionPosition="center" >}}
...
{{< figure src="img/old-handlebar-tape.jpg" alt="Old handlebar tape" caption="The old handlebar grip tape more closely resembled a hard plastic shell." captionPosition="center" >}}
...
{{< figure src="img/new-grip-tape.png" alt="Orange grip tape" caption="I'm pretty sure this is what I bought at my bike shop." captionPosition="center" >}}
...
{{< figure src="img/water-bottle-cage.png" alt="Water bottle cage" caption="A water bottle cage pretty similar to what I purchased." captionPosition="center" >}}
...
{{< video src="vid/hank-hill-wd40.mp4" alt="Hank Hill WD-40"  >}}

### Chain Lube

I just went to Walmart and grabbed whatever they had.

{{< figure src="img/chain-lube.png" alt="Chain lube" caption="The lightning bolt makes it go faster." captionPosition="center" >}}
...
{{< figure src="img/tire-lever-usage.jpg" alt="Tire lever usage" caption="This is how you're supposed to use a tire lever." captionPosition="center" >}}

I bought a [4-pack on Amazon](https://www.amazon.com/gp/product/B07FDS3VCW/).

{{< figure src="img/tire-levers.png" alt="Tire levers" caption="You might be beginning to realize that I like the color red." captionPosition="center" >}}
...
{{< figure src="img/wire-brush.png" alt="Wire brush" caption="Generic wire brush" captionPosition="center" >}}

### Air Pump

Lastly, while at Walmart I got a Bell air pump.

{{< figure src="img/bell-air-pump.png" alt="Bell air pump" caption="I bought an air pump that's something like this." captionPosition="center" >}}
...
{{< figure src="img/bike-living-room.jpg" alt="My bicycle being worked on in a living room" caption="First time working on the bike in my friend's living room." captionPosition="center" >}}
...
{{< figure src="img/dirty-bike.jpg" alt="Dirty bicycle" caption="This was <i>after</i> trying to clean it." captionPosition="center" >}}
...
{{< figure src="img/rear-wheel-alignment.jpg" alt="Rear wheel alignment" caption="I added the two blue lines to show that the wheel is not centered between the rear two forks. You can also tell by how the brake assembly is tilted a bit to the left." captionPosition="center" >}}

{{< figure src="img/rear-tire-rubbing.jpg" alt="Rear tire rubbing" caption="It was hard to get my camera in a position to show it well, but you can kind of see where the tire was rubbing on the frame closest to the camera in the past." captionPosition="center" >}}

{{< figure src="img/rear-wheel-mount.jpg" alt="Rear wheel mount" caption="In order to get the wheel to track straight, we had to bring the left side very far forward. A few ugga duggas were used to keep it nice and snug. I swear there is some material holding it on." captionPosition="center" >}}
...
{{< figure src="img/rear-cable-frayed.jpg" alt="Rear shifter cable frayed" caption="You can see at the bottom that it was frayed pretty bad." captionPosition="center" >}}
...
{{< figure src="img/rear-cable-removal.jpg" alt="Rear shifter cable removal" caption="It went out swinging." captionPosition="center" >}}
...
{{< figure src="img/fun-in-less-sun.jpg" alt="Bike in the sun" caption="I was starting to ride the bike to class now." captionPosition="center" >}}
...
{{< figure src="img/new-handlebar-tape.jpg" alt="New handlebar tape" caption="The new handlebar tape matches really closely and the bike shop did a great job wrapping it." captionPosition="center" >}}
...
{{< figure src="img/water-bottle-cage-mounted.jpg" alt="Water bottle cage mounted" caption="Two hose clamps slipped under the shifting lines hold it nice and snug." captionPosition="center" >}}
...
{{< figure src="img/schwinn-lights.png" alt="Schwinn lights" caption="The Schwinn brand lights I got at Walmart." captionPosition="center" >}}
...
{{< figure src="img/night-lights.jpg" alt="Night lights" caption="I think it looks pretty good at night." captionPosition="center" >}}
...
{{< figure src="img/fun-in-the-sun.jpg" alt="Final result" caption="It looks really bright orange in the sun." captionPosition="center" >}}

I think the bike looks pretty good in it's own special patina way.

{{< figure src="img/schwinn-badge.jpg" alt="Schwinn badge" caption="The front Schwinn badge is in surprisingly good shape." captionPosition="center" >}}

{{< figure src="img/rusty-paint.jpg" alt="Rusty paint" caption="The Schwinn logo on the side isn't doing so well, though." captionPosition="center" >}}
...
{{< figure src="img/old-phone-number.jpg" alt="Rusty paint" caption="The phone number is 11 digits???" captionPosition="center" >}}
